    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        <div>
          ...
          <div className="w-full bg-neutral-800 p-5 mb-10 rounded-lg shadow-lg flex flex-col sm:flex-row sm:flex-wrap justify-between gap-5">
            <div className="max-w-[18rem] rounded-lg shadow bg-neutral-700 border-2">
