      ...
      <div className="flex flex-col items-center justify-center mt-10">
        <div className="flex-col">            
          <div className="flex flex-col w-full max-sm:h-full p-5">
            ...
            <div className="w-fit flex items-center mb-5 pl-5 pr-5 py-5 bg-neutral-800 rounded-lg">
              <div className="bg-gradient-to-b from-[#BA6CEB] to-[#4D5ECF] rounded-full p-4 mr-5 max-sm:hidden">
                  <img className="w-12" src="/logo.png" alt="logo" />
              </div>
              
              <div>
                <p className="text-3xl font-bold text-purple-500">Username</p>
                <p>placeholder@gmail.com</p>
              </div>

              <div className="flex select-none">
                <button type="button" className="text-sm font-semibold text-center border-2 border-red-500 rounded-lg px-3 py-2 ml-5 text-red-500 cursor-default hover:bg-red-700 hover:text-white">
                  <span>Ban User</span>
                </button>
